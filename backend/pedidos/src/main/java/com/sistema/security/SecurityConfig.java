	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http
				...
				.authorizeHttpRequests(auth -> auth
						...
						.requestMatchers(HttpMethod.POST, "/zonas").hasAnyRole("ENCARGADO_DEPOSITO", "ADMINISTRATIVO")
						.requestMatchers(HttpMethod.PUT, "/zonas/*").hasAnyRole("ENCARGADO_DEPOSITO", "ADMINISTRATIVO")
						.requestMatchers(HttpMethod.PATCH, "/zonas/*/desactivar", "/zonas/*/reactivar").hasAnyRole("ENCARGADO_DEPOSITO", "ADMINISTRATIVO")
