	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http
				...
				.authorizeHttpRequests(auth -> auth
						...
						.requestMatchers(HttpMethod.POST, "/pedidos/*/reintentar-stock").hasAnyRole("ENCARGADO_DEPOSITO", "ADMINISTRATIVO")
						...
						.requestMatchers(HttpMethod.POST, "/rutas", "/rutas/*/pedidos").hasRole("ADMINISTRATIVO")
						...
						.requestMatchers(HttpMethod.GET, "/reportes/cobranzas/exportar.csv").hasAnyRole("VENDEDOR", "ADMINISTRATIVO")
						...
						.requestMatchers(HttpMethod.GET, "/zonas", "/zonas/**").authenticated()
						.requestMatchers(HttpMethod.POST, "/zonas").hasRole("ADMINISTRATIVO")
						.requestMatchers(HttpMethod.PUT, "/zonas/*").hasRole("ADMINISTRATIVO")
						.requestMatchers(HttpMethod.PATCH, "/zonas/*/desactivar", "/zonas/*/reactivar").hasRole("ADMINISTRATIVO")
						...
						.requestMatchers(HttpMethod.POST, "/cobranzas").hasAnyRole("VENDEDOR", "ADMINISTRATIVO", "REPARTIDOR")
