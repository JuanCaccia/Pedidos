...
public class StockController {
	...
	public ResponseEntity<MovimientoStockResponse> registrarMerma(@RequestBody MermaRequest request) {
	...
	public ResponseEntity<MovimientoStockResponse> ajustarInventario(@RequestBody AjusteRequest request) {
	...
	public ResponseEntity<StockResponse> obtenerStock(@PathVariable Long itemId) {
		return consultarStock.buscarItemPorId(itemId)
				.map(item -> StockResponse.of(item,
